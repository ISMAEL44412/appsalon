...
-- el usuario puede crear multiples citas con diferentes servicios

CREATE TABLE citasServicios(
    -- una cita tiene un solo servicio
    id INT(11) NOT NULL AUTO_INCREMENT,
    cita_id INT(11),
    servicio_id INT(11),
    ...
    CONSTRAINT servicio_fk FOREIGN KEY(servicio_id) REFERENCES servicios(id)
        ON DELETE SET NULL
        ON UPDATE SET NULL,
    CONSTRAINT citasServicios_id PRIMARY KEY (id)
);
